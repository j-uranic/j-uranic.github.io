...
| --- | --- | --- |
| <code>(processedMicroscopy&#124;processed_microscopy)/[^/]+_images/[^/]+\.ome\.(tif&#124;tiff)</code> | ✓ | THIS IS THE EDITED VERSION |
...
| <code>(rawMicroscopy&#124;raw_microscopy)/[^/]+\.czi</code> | ✓ | Raw microscope file for the [experiment](https://www.google.com) |
